                       ...
                       <div class="controls">
                            ...
                            <div id="my-tab-content" class="tab-content">
                                <div class="tab-pane active" id="Castellano'.$c.'">
                                    ...
                                    <input class="input-xlarge focused" id="alt_img_1" name="banner_img['.$c.'][alt_img][1]" type="text" value="">
                                </div></div></div>
                                <div class="tab-pane" id="Catalan'.$c.'">
                                    <div class="control-group">
                                    <div class="controls" style="margin-left:0px;">
                                    <input class="input-xlarge focused" id="alt_img_2" name="banner_img['.$c.'][alt_img][2]" type="text" value="">
                                </div></div></div>
                             </div>   
                            <input value="" type="hidden" name="banner_img['.$c.'][alt_img][itemLiteralId]" type="text">
                       </div>
                   </div>';
                       ...
                       <div class="controls">
                            ...
                            <div id="my-tab-content" class="tab-content">
                                <div class="tab-pane active" id="Castellano'.($c + 1).'">
                                    <div class="control-group">
                                    <div class="controls" style="margin-left:0px;">
                                    <input class="input-xlarge focused" id="desc_img_1" name="banner_img['.$c.'][desc_img][1]" type="text" value="">
                                </div></div></div>
                                <div class="tab-pane" id="Catalan'.($c + 1).'">
                                    <div class="control-group">
                                    <div class="controls" style="margin-left:0px;">
                                    <input class="input-xlarge focused" id="desc_img_2" name="banner_img['.$c.'][desc_img][2]" type="text" value="">
                                </div></div></div>
                             </div>   
                            <input value="" type="hidden" name="banner_img['.$c.'][desc_img][itemLiteralId]" type="text">
                       </div>
                   </div>
                   <div class="control-group">
                       <label class="control-label" for="df">Imágen</label>
                       <div class="controls">
                           <input value="" class="input-xlarge focused" id="" name="banner_img['.$c.'][banner_img]" type="file">
                           <input type="hidden" name="banner_img['.$c.'][itemid]" value="-1">
                       </div>
                   </div>
                   </fieldset></div>';
echo $output;
